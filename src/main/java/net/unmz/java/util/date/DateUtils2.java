...
/***
 * https://blog.csdn.net/yrryyff/article/details/83546656
 * https://www.cnblogs.com/sharpest/p/7879377.html
 *
 * https://blog.csdn.net/baidu_36327010/article/details/80747996
 */
//
...
public class DateUtils2 {
        ...
        public static String getWeek(String sdate, String num) {
            // 再转换为时间
            Date dd = DateUtils2.strToDate(sdate);
        ...
        public static String getWeek(String sdate) {
            // 再转换为时间
            Date date = DateUtils2.strToDate(sdate);
            Calendar c = Calendar.getInstance();
            c.setTime(date);
        ...
        public static String getNowMonth(String sdate) {
            ...
            String newday = DateUtils2.getNextDay(sdate, (1 - u) + "");
            return newday;
        }
